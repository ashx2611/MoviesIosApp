...
import Firebase
class TopratedViewController:  UITableViewController//UIViewController,UITableViewDataSource,UITableViewDelegate
{
    ...
    func JSONdownload(completed :@escaping ()->()){
        let jsonUrlString = "https://api.themoviedb.org/3/movie/top_rated?api_key=ab41e4fadb84a730ff67b48d69a670f6"
